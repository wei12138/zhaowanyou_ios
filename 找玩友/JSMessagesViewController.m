...
- (void)setup
{
	...
	if (kAllowsMedia)
	{
		...
		CGRect frame = CGRectMake(8, 0, image.size.width, image.size.height);
...
{
    FaceSelectedViewController* faceSelectedView = [[FaceSelectedViewController alloc] init];
    [self presentViewController:faceSelectedView animated:YES completion:^{NSLog(@"系统表情视图打开!!");}];
}
